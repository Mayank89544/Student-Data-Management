            ...
            if (option == 1) {
                ...
                for (int i = 0; i < count_n; i++) {
                    ...
                    if (strcmp(subcode, code1.c_str()) == 0) {
                        if(i==0){
                            file.seekp(24 + 37 * i, std::ios_base::beg);
                        }else{
                            file.seekp(24 + i + 38 * i, std::ios_base::beg);
                        }
                    ...
                    if (strcmp(subcode, code2.c_str()) == 0) {
                        if(i==0){
                            file.seekp(27 + 37 * i, std::ios_base::beg);
                        }else{
                            file.seekp(27 + i + 38 * i, std::ios_base::beg);
                        }
                        cout << "Enter the mark of student#" << (i + 1) << " : ";
                        cin >> mark;
                        file.write(mark.c_str(), 2);
